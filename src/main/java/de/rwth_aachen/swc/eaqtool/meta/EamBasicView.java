...
public class EamBasicView implements Serializable
{
    ...
    private final static long serialVersionUID = 3095968236647704652L;
    ...
    public EamBasicView withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public EamBasicView withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EamBasicView) == false) {
            return false;
        }
        EamBasicView rhs = ((EamBasicView) other);
