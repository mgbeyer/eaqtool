...
public class EamViewScope implements Serializable
{
    ...
    private final static long serialVersionUID = 7152486134879804856L;
    ...
    public EamViewScope withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public EamViewScope withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EamViewScope) == false) {
            return false;
        }
        EamViewScope rhs = ((EamViewScope) other);
